...
function Footer() {
    return (
        <div>
            <div className="back_to_top"><a href="#top">Back to Top</a></div>
            ...
            <div className='logo_wraper'>
                <div className='container_1'>
                    <div className="footer_logo">
                        <a href="/#"><img  className="header__logo"src="http://pngimg.com/uploads/amazon/amazon_PNG11.png"/></a></div>
                <div className="USA">
                        <img className="flag" src="https://icons.iconarchive.com/icons/wikipedia/flags/512/US-United-States-Flag-icon.png" /><p className="USA_1">United States</p></div>
                </div>
            </div>
        </div>
